...
from rnaseq.db_setup import connect_database, create_tables, insert_postgresql_db
...
class TestInsertPostgresqlDb:
    ...
    def test_insert_postgresql_db_basic(self):
        ...
        try:
            ...
            insert_postgresql_db(
                mock_conn, temp_file, "test_table", "test_dataset", "1.0", "test_run"
            )
    ...
    def test_insert_postgresql_db_with_none_values(self):
        ...
        try:
            ...
            insert_postgresql_db(
                mock_conn, temp_file, "test_table", dataset_id=None, version=None, run_name=None
            )
    ...
    def test_insert_postgresql_db_samples_table_upsert(self):
        ...
        try:
            ...
            mock_conn.cursor.return_value.__enter__.return_value = mock_cursor
            mock_cursor.fetchone.return_value = (1,)
            mock_cursor.fetchall.return_value = [("sample_id",), ("condition",), ("geo_accession",)]

            insert_postgresql_db(mock_conn, temp_file, "samples", "test_dataset", "1.0", "test_run")
    ...
    def test_insert_postgresql_db_with_sample_insertion(self):
        ...
        try:
            ...
            insert_postgresql_db(
                mock_conn, temp_file, "qc_metrics", "test_dataset", "1.0", "test_run"
            )
